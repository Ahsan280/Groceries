...
import image1 from "../../../assets/about/Pics/6.jfif";
import image2 from "../../../assets/about/Pics/7.jfif";
const AboutText2 = () => {
  return (
    <div className="inria-sans-regular">
      <div
        className=" ms-2 grid grid-cols-1 md:grid-cols-2 "
      ...
      {/* ----------------- */}
      <div className="mt-20 ms-2 grid grid-cols-1 md:grid-cols-2 ">
        <div className="flex flex-col justify-center items-center py-48">
          <div className="flex flex-col w-[80%] md:w-[60%] gap-3">
            <h1 className="text-start text-4xl font-semibold">
              Free text online
